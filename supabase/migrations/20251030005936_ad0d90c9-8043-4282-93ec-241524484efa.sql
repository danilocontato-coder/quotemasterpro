-- Corrigir get_quote_timeline para usar nomes corretos de colunas
-- Troca total_price por total em quotes e quote_responses
...
BEGIN
  ...
  WITH all_events AS (
    ...
    WHERE qr.quote_id = p_quote_id::UUID
    ...
    WHERE apa.quote_id = p_quote_id::UUID
    ...
    WHERE qv.quote_id = p_quote_id::UUID
    ...
    WHERE d.quote_id = p_quote_id::UUID
    ...
    WHERE a.quote_id = p_quote_id::UUID
  )
