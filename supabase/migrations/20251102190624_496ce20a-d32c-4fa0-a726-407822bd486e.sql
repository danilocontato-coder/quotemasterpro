-- =====================================================
-- MIGRATION: Invitation Letters Module - Sprint 1 (Fixed)
-- =====================================================

-- Create ENUM for invitation letter status
CREATE TYPE invitation_letter_status AS ENUM ('draft', 'sent', 'cancelled');

-- Create ENUM for supplier response status
...
CREATE INDEX idx_invitation_letters_client_id ON invitation_letters(client_id);
CREATE INDEX idx_invitation_letters_quote_id ON invitation_letters(quote_id);
CREATE INDEX idx_invitation_letters_status ON invitation_letters(status);
CREATE INDEX idx_invitation_letters_deadline ON invitation_letters(deadline);
CREATE INDEX idx_invitation_letters_created_at ON invitation_letters(created_at DESC);

-- =====================================================
-- TABLE: invitation_letter_suppliers
-- =====================================================
CREATE TABLE invitation_letter_suppliers (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Create indexes
CREATE INDEX idx_invitation_letter_suppliers_letter_id ON invitation_letter_suppliers(invitation_letter_id);
CREATE INDEX idx_invitation_letter_suppliers_supplier_id ON invitation_letter_suppliers(supplier_id);
CREATE INDEX idx_invitation_letter_suppliers_response_status ON invitation_letter_suppliers(response_status);
CREATE INDEX idx_invitation_letter_suppliers_token ON invitation_letter_suppliers(response_token);
...
-- Storage policies for attachments (Fixed type casting)
