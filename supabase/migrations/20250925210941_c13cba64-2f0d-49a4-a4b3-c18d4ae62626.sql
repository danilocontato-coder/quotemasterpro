-- URGENTE: Verificar e recriar função RLS para prevenir vazamento de dados entre fornecedores

-- Primeiro, vamos recriar a função current_user_can_see_quote com segurança aprimorada
