...
-- 3. ATUALIZAR FUNÇÃO DE VERIFICAÇÃO DE INTEGRIDADE
-- Agora aceita que stored_count >= actual_count (cotações deletadas)
...
-- 4. ATUALIZAR FUNÇÃO DE RECÁLCULO
-- Nota: Esta função agora serve apenas para CORRIGIR contadores que foram
-- decrementados indevidamente pela vulnerabilidade anterior
