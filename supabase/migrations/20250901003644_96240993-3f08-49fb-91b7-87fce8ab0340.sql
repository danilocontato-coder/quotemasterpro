...
-- Insert default permission profiles with proper UUIDs
INSERT INTO public.permission_profiles (id, name, description, permissions, client_id) VALUES
('11111111-1111-1111-1111-111111111111', 'Administrador', 'Acesso completo ao sistema', '{
...
('22222222-2222-2222-2222-222222222222', 'Gerente', 'Gerencia cotações, fornecedores e equipe', '{
...
('33333333-3333-3333-3333-333333333333', 'Colaborador', 'Cria e edita cotações', '{
  "quotes": {"view": true, "create": true, "edit": true, "delete": false},
...
('44444444-4444-4444-4444-444444444444', 'Fornecedor', 'Responde cotações e gerencia catálogo', '{
