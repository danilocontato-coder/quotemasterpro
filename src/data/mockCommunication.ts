...
export const mockAnnouncements: Announcement[] = [
  {
    ...
    content: 'Implementamos novas funcionalidades no sistema de cotações e pagamentos. Confira as novidades: chat integrado com fornecedores, sistema de escrow para pagamentos seguros e relatórios avançados.',
    type: 'info',
    priority: 'medium',
    targetAudience: 'all',
    createdBy: 'ADMIN001',
...
export const mockTickets: Ticket[] = [
  ...
  },
  {
    ...
    description: 'Como funciona exatamente o sistema de escrow? Gostaria de entender melhor antes de processar um pagamento.',
    status: 'resolved',
    priority: 'medium',
    category: 'Dúvida',
    clientId: '1',
    ...
    messages: [
      {
        ...
        senderName: 'João Silva',
        senderType: 'client',
        content: 'Como funciona exatamente o sistema de escrow? Gostaria de entender melhor antes de processar um pagamento.',
        attachments: [],
      ...
      },
      {
        ...
        senderType: 'support',
        content: 'O sistema de escrow funciona como uma garantia. O valor fica retido conosco até você confirmar o recebimento dos produtos/serviços. Após 10 dias, se não houver manifestação, o valor é liberado automaticamente para o fornecedor.',
