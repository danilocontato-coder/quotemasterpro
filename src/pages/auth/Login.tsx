...
import { Loader2, Eye, EyeOff, FileText, Building2 } from 'lucide-react';
import { LoginTypeSwitcher } from '@/components/auth/LoginTypeSwitcher';
...
const Login: React.FC = () => {
  ...
  const [loginType, setLoginType] = useState<'client' | 'supplier' | 'admin'>('client');
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="mt-6 text-xs text-muted-foreground text-center border-t pt-4">
              <p className="mb-2 font-medium">Dados para teste ({loginType}):</p>
              <div className="bg-muted/50 rounded p-3">
                <p><strong>Email:</strong> {placeholders.testData.email}</p>
                <p><strong>Senha:</strong> {placeholders.testData.password}</p>
              </div>
            </div>
          </CardContent>
        </Card>
