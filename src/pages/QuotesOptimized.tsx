...
export default function Quotes() {
  ...
  return (
    <OptimizedQuotesWrapper>
      {({ quotes, createQuote, updateQuote, deleteQuote, isLoading, error, markQuoteAsReceived, refetch, enforceLimit }) => {
          ...
          <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <QuoteComparisonButton quotes={quotes || []} />
                <Button 
                  variant="outline" 
            ...
            <DeleteConfirmationModal
              ...
              quoteName={quoteToDelete?.title || `Cotação ${quoteToDelete?.id}`}
            />

            <DecisionMatrixManager
              open={isMatrixManagerOpen}
              onOpenChange={setIsMatrixManagerOpen}
              quotes={quotes || []}
            />
            ...
            <SendQuoteToSuppliersModal
              ...
              enforceLimit={async () => {
                const canProceed = await enforceLimit("SEND_QUOTE");
                return canProceed;
              }}
            />
          </div>
