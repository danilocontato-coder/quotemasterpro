...
const TEMPLATE_TYPES = [
  ...
  { value: 'supplier_registration_invite', label: 'Convite de Cadastro (WhatsApp)', icon: MessageSquare, category: 'whatsapp' },
  { value: 'proposal_received_whatsapp', label: 'Proposta Recebida (WhatsApp)', icon: MessageSquare, category: 'whatsapp' },
  { value: 'email_quote_request', label: 'Solicitação de Cotação (E-mail)', icon: Mail, category: 'email' },
  { value: 'email_supplier_invite', label: 'Convite de Cadastro (E-mail)', icon: Mail, category: 'email' },
  { value: 'email_payment_confirmation', label: 'Confirmação de Pagamento (E-mail)', icon: Mail, category: 'email' },
  { value: 'email_quote', label: 'Cotação (Email - Legacy)', icon: Mail, category: 'email' },
...
const DEFAULT_VARIABLES: Record<string, Record<string, string>> = {
  ...
  email_quote_request: {
    ...
    client_phone: 'Telefone do cliente',
    quote_title: 'Título da cotação',
    quote_id: 'Código da cotação (RFQ01)',
    deadline_formatted: 'Data limite formatada',
    items_count: 'Número total de itens',
    items_list: 'Lista de itens detalhada',
    total_formatted: 'Valor total formatado',
    proposal_link: 'Link para envio de proposta',
    company_name: 'Nome da empresa/plataforma',
    primary_color: 'Cor primária (#003366)',
    accent_color: 'Cor de destaque (#0066CC)',
  ...
  email_supplier_invite: {
    ...
    client_name: 'Nome do cliente',
    company_name: 'Nome da empresa/plataforma',
    registration_link: 'Link de cadastro',
    primary_color: 'Cor primária (#003366)',
    accent_color: 'Cor de destaque (#0066CC)',
    footer_text: 'Texto do rodapé'
  },
  email_payment_confirmation: {
    ...
    view_link: 'Link para visualizar detalhes',
    company_name: 'Nome da empresa/plataforma',
    primary_color: 'Cor primária (#003366)',
    accent_color: 'Cor de destaque (#0066CC)',
    footer_text: 'Texto do rodapé'
