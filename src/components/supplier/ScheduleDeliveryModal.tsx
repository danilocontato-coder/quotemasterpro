          ...
          <div className="space-y-4 py-4">
            ...
            {sourceData && (
              <div className="bg-muted/50 p-3 rounded-lg">
                <h3 className="font-medium mb-2 text-sm">Resumo da Cotação</h3>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 p-3 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              {fullAddress ? (
                <div className="space-y-2">
                  <div className="bg-white dark:bg-gray-900 p-2.5 rounded border">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-950/20 p-2.5 rounded border border-yellow-200 dark:border-yellow-900">
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                <Label htmlFor="scheduled-date" className="flex items-center gap-2 text-sm">
              ...
              <div className="space-y-2">
                <Label htmlFor="delivery-address" className="flex items-center gap-2 text-sm">
              ...
              <div className="space-y-2">
                <Label htmlFor="transport-type" className="flex items-center gap-2 text-sm">
              ...
              {transportType && (
                <div className="space-y-2">
                  <Label htmlFor="transport-details" className="text-sm">
