...
interface EditSupplierUserModalProps {
  open: boolean;
  onClose: () => void;
  user: SupplierUser | null;
}

export function EditSupplierUserModal({ open, onClose, user }: EditSupplierUserModalProps) {
  const { updateUser, permissionProfiles } = useSupplierUsers();
