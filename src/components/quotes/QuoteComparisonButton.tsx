...
export function QuoteComparisonButton({ 
  ...
  const fetchProposals = async () => {
    ...
    try {
      ...
      // Query with supplier join to get correct names
      ...
      console.log('🔍 DEEP DEBUG - Responses with supplier join:', responses, 'error:', error);
      ...
      const transformedProposals: QuoteProposal[] = (responses || []).map(response => ({
        ...
        supplierName: response.suppliers?.name || response.supplier_name || 'Fornecedor não identificado',
